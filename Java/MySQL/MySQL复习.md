...
```mysql
mysql -h 地址 -P 端口 -u 用户名 -p 密码 -- 进入mysql客户端
...
-- eg: CREATE DATABASE db1 CHARACTER SET utf8
...
-- eg
            CREATE TABLE t_user(
            uid INT(10) AUTO_INCREMENT COMMENT 'ID',
            uage INT(3) COMMENT '年龄',
            uname VARCHAR(10) COMMENT '姓名',
            uaddress VARCHAR(32) COMMENT '地址',
            utel VARCHAR(15) COMMENT '电话',
            PRIMARY KEY(id)
            )COMMENT='用户表';
