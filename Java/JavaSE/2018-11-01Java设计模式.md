...
//弊端 弱被装饰类方法特别多 则需要对很多方法进行装饰 此时采用代理模式比较好
```
...
public class DynamicInvocationHandler implements InvocationHandler {
    ...
    /**
     * @param proxy 代表生成的动态代理对象
     * @param method 代表正在执行的方法
     * @param args  代表调用目标方法时传入的实参
     * @return
     * @throws Throwable
     */
    @Override //对方法的增强就在这里操作
...
//参数1  类加载器 固定写法 在哪个类调用就写哪个类的类加载器 currentClass.class.getClassLoader();
...
```java
 ...
 2.创建InvocationHandler接口实现类 重写invoke方法 实现增强
