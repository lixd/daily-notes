...
public interface  Engine {
    public void installEngineA();
    public void installEngineB();
}


public class CarX implements Engine {
    @Override
    public void installEngineA() {
        System.out.println("CarX安装A引擎");
    }

    @Override
    public void installEngineA() {
        System.out.println("CarX安装B引擎");      
    }
}


public class CarY implements Engine {

     @Override
    public void installEngineA() {
        System.out.println("CarY安装A引擎");
    }

    @Override
    public void installEngineA() {
        System.out.println("CarY安装B引擎");      
    }
}
...
public class CarX extends Car {
    public CarX(Engine engine) {
        super(engine);
    }
    @Override
    public void install() {
        System.out.println("CarX安装");
        this.getEngine().installEngine();
    }
}
public class CarY extends Car {
    public CarY(Engine engine) {
        super(engine);
    }
    @Override
    public void install() {
        System.out.println("CarY安装");
        this.getEngine().installEngine();
    }
}
//测试
public class Test {
    public static void main(String[] args) {
        ...
        //创建抽象    ->车
        Car carX=new CarY(engineA);
        carX.install();
        Car carY=new CarY(engineB);
        carY.install();
    }
}
...
```
原文：https://blog.csdn.net/tanggao1314/article/details/50611958 
